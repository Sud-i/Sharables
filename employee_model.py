...
class Employee(Base):
    ...
    leave_applications = relationship("LeaveApplication", foreign_keys="LeaveApplication.employee_id")
    
    # Punch and Attendance relationships
    punch_records = relationship("PunchRecord", foreign_keys="PunchRecord.employee_id", back_populates="employee")
    attendance_records = relationship("AttendanceRecord", foreign_keys="AttendanceRecord.employee_id")
